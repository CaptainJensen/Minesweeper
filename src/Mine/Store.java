...
public class Store extends GridPane {
    ...
    enum SHOPITEMS {
        ...
        BLUE(new ShopItem(ImageHandler.getBlueFlagImg(),"Blue","Beta Testers","Unlocked during \nbeta","")),
        ...
        PINK(new ShopItem(ImageHandler.getPinkFlagImg(),"Pink","Read the rules","","")),
        BROWN(new ShopItem(ImageHandler.getBrownFlagImg(),"Brown","Hidden","","")),
        WHITE(new ShopItem(ImageHandler.getWhiteFlagImg(),"White","Support the game","","Report")),
        GREY(new ShopItem(ImageHandler.getGreyFlagImg(),"Grey","500 Miles","","Keep on walking")),
        FULLBLACK(new ShopItem(ImageHandler.getBlackfullFlagImg(),"Black","Tuesday for\n12 Hours?","","")),
        HAZARD(new ShopItem(ImageHandler.getHazardFlagImg(),"Hazard","Forget the past","","Restart")),
        RAINBOW(new ShopItem(ImageHandler.getRainbowFlagImg(),"Rainbow","Update?","","")),
        ...
        CAMMO(new ShopItem(ImageHandler.getCammoFlagImg(),"Cammo", "Change your name","","Blend in")),
